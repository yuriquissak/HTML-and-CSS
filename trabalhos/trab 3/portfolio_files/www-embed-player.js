...
var Ba=/&([^;\s<&]+);?/g,Ea={"\x00":"\\0","\b":"\\b","\f":"\\f","\n":"\\n","\r":"\\r","\t":"\\t","\x0B":"\\x0B",'"':'\\"',"\\":"\\\\","<":"<"},Fa={"'":"\\'"};
function Ga(a,b){for(var c=0,d=ra(String(a)).split("."),e=ra(String(b)).split("."),f=Math.max(d.length,e.length),h=0;0==c&&h<f;h++){var k=d[h]||"",l=e[h]||"";do{k=/(\d*)(\D*)(.*)/.exec(k)||["","","",""];l=/(\d*)(\D*)(.*)/.exec(l)||["","","",""];if(0==k[0].length&&0==l[0].length)break;c=Ha(0==k[1].length?0:parseInt(k[1],10),0==l[1].length?0:parseInt(l[1],10))||Ha(0==k[2].length,0==l[2].length)||Ha(k[2],l[2]);k=k[3];l=l[3]}while(0==c)}return c}
...
b.call(c,l,k,a)&&(e[f++]=l)}return e},La=Array.prototype.map?function(a,b,c){return Array.prototype.map.call(a,b,c)}:function(a,b,c){for(var d=a.length,e=Array(d),f=v(a)?a.split(""):a,h=0;h<d;h++)h in f&&(e[h]=b.call(c,f[h],h,a));
...
function B(a,b){return 0<=Ja(a,b)}
function Ra(a,b){B(a,b)||a.push(b)}
function Sa(a,b){var c=Ja(a,b),d;(d=0<=c)&&Array.prototype.splice.call(a,c,1);return d}
function Ta(a,b){var c=Qa(a,b,void 0);0<=c&&Array.prototype.splice.call(a,c,1)}
...
!ga(m.setImmediate)||m.Window&&m.Window.prototype&&!C("Edge")&&m.Window.prototype.setImmediate==m.setImmediate?(Nb||(Nb=Ob()),Nb(a)):m.setImmediate(a)}}
...
function $b(a,b){a.Ka?p(void 0)?b.call(void 0):b():(a.T||(a.T=[]),a.T.push(p(void 0)?w(b,void 0):b))}
E.prototype.A=function(){if(this.T)for(;this.T.length;)this.T.shift()()};
function F(a){a&&"function"==typeof a.dispose&&a.dispose()}
function ac(a){for(var b=0,c=arguments.length;b<c;++b){var d=arguments[b];ea(d)?ac.apply(null,d):F(d)}}
;function G(a){E.call(this);this.i=1;this.f=[];this.g=0;this.b=[];this.ha={};this.j=!!a}
y(G,E);g=G.prototype;g.subscribe=function(a,b,c){var d=this.ha[a];d||(d=this.ha[a]=[]);var e=this.i;this.b[e]=a;this.b[e+1]=b;this.b[e+2]=c;this.i=e+3;d.push(e);return e};
g.unsubscribe=function(a,b,c){if(a=this.ha[a]){var d=this.b;if(a=Pa(a,function(a){return d[a+1]==b&&d[a+2]==c}))return this.na(a)}return!1};
...
g.clear=function(a){if(a){var b=this.ha[a];b&&(z(b,this.na,this),delete this.ha[a])}else this.b.length=0,this.ha={}};
...
function sc(a){var b=rc();b&&("number"==typeof a?a=[a]:"string"==typeof a&&(a=[parseInt(a,10)]),z(a,function(a){b.unsubscribeByKey(a);delete mc[a]}))}
...
function vc(a){nc[a]&&(a=nc[a],z(a,function(a){mc[a]&&delete mc[a]}),a.length=0)}
...
function Ac(a,b){var c=Bc(a),d=document.getElementById(c),e=d&&D(d,"loaded"),f=d&&!e;if(e){b&&b();return}if(b){var e=qc(c,b),h=""+ia(b);Cc[h]=e}if(f)return;d=Dc(a,c,function(){D(d,"loaded")||(Ib(d,"loaded","true"),tc(c),I(na(wc,c),0))})}
...
function Bc(a){var b=document.createElement("a");Gb(b,a);a=b.href.replace(/^[a-zA-Z]+:\/\//,"//");return"js-"+Ia(a)}
...
function Mc(a,b,c){if(ea(a))try{z(a,b,c)}catch(d){if(d!==Jc)throw d;}else{a=Lc(a);try{for(;;)b.call(c,a.next(),void 0,a)}catch(d){if(d!==Jc)throw d;}}}
...
;function Sc(a){return a.W&&"function"==typeof a.W?a.W():ea(a)||v(a)?a.length:bb(a)}
function Tc(a){if(a.X&&"function"==typeof a.X)return a.X();if(v(a))return a.split("");if(ea(a)){for(var b=[],c=a.length,d=0;d<c;d++)b.push(a[d]);return b}return eb(a)}
function Uc(a){if(a.qa&&"function"==typeof a.qa)return a.qa();if(!a.X||"function"!=typeof a.X){if(ea(a)||v(a)){var b=[];a=a.length;for(var c=0;c<a;c++)b.push(c);return b}return fb(a)}}
function Vc(a,b,c){if(a.forEach&&"function"==typeof a.forEach)a.forEach(b,c);else if(ea(a)||v(a))z(a,b,c);else for(var d=Uc(a),e=Tc(a),f=e.length,h=0;h<f;h++)b.call(c,e[h],d&&d[h],a)}
function Wc(a,b){if("function"==typeof a.every)return a.every(b,void 0);if(ea(a)||v(a))return Oa(a,b,void 0);for(var c=Uc(a),d=Tc(a),e=d.length,f=0;f<e;f++)if(!b.call(void 0,d[f],c&&c[f],a))return!1;return!0}
...
function $c(a,b){var c=Sc(b);if(a.W()>c)return!1;!(b instanceof Xc)&&5<c&&(b=new Xc(b));return Wc(a,function(a){var c=b;return c.contains&&"function"==typeof c.contains?c.contains(a):c.$a&&"function"==typeof c.$a?c.$a(a):ea(c)||v(c)?B(c,a):db(c,a)})}
...
md&&(ld=md?md[1]:"");if(K){var nd=jd();if(null!=nd&&nd>parseFloat(ld)){kd=String(nd);break a}}kd=ld}var od=kd,dd={};function pd(a){return cd(a,function(){return 0<=Ga(od,a)})}
...
;function Od(a){"?"==a.charAt(0)&&(a=a.substr(1));a=a.split("&");for(var b={},c=0,d=a.length;c<d;c++){var e=a[c].split("=");if(1==e.length&&e[0]||2==e.length){var f=sa(e[0]||""),e=sa(e[1]||"");f in b?da(b[f])?Wa(b[f],e):b[f]=[b[f],e]:b[f]=e}}return b}
...
function Wd(a,b){var c=b.format||"JSON";b.cf&&(a=document.location.protocol+"//"+document.location.hostname+(document.location.port?":"+document.location.port:"")+a);var d=H("XSRF_FIELD_NAME",void 0),e=H("XSRF_TOKEN",void 0),f=b.Wb;f&&(f[d]&&delete f[d],a=Pd(a,f||{}));var h=b.postBody||"",f=b.O;Vd(a,b)&&(f||(f={}),f[d]=e);f&&v(h)&&(d=Od(h),nb(d,f),h=b.Gc&&"JSON"==b.Gc?JSON.stringify(d):Ld(d));var k=!1,l,n=Sd(a,function(a){if(!k){k=!0;l&&J(l);var d=Rd(a),e=null;if(d||400<=a.status&&500>a.status)e=
...
return n}
function Xd(a,b,c){var d=null;switch(a){case "JSON":a=b.responseText;b=b.getResponseHeader("Content-Type")||"";a&&0<=b.indexOf("json")&&(d=vd(a));break;case "XML":if(b=(b=b.responseXML)?Yd(b):null)d={},z(b.getElementsByTagName("*"),function(a){d[a.tagName]=Zd(a)})}c&&$d(d);
return d}
function $d(a){if(ha(a))for(var b in a){var c;(c="html_content"==b)||(c=b.length-5,c=0<=c&&b.indexOf("_html",c)==c);if(c){c=b;var d;d=Fb(a[b]);a[c]=d}else $d(a[b])}}
function Yd(a){return a?(a=("responseXML"in a?a.responseXML:a).getElementsByTagName("root"))&&0<a.length?a[0]:null:null}
function Zd(a){var b="";z(a.childNodes,function(a){b+=a.nodeValue});
return b}
...
var ke={stopImmediatePropagation:1,stopPropagation:1,preventMouseEvent:1,preventManipulation:1,preventDefault:1,layerX:1,layerY:1,scale:1,rotation:1,webkitMovementX:1,webkitMovementY:1};function le(a){if(a.classList)return a.classList;a=a.className;return v(a)&&a.match(/\S+/g)||[]}
...
function oe(a,b){a.classList?a.classList.remove(b):me(a,b)&&(a.className=Ka(le(a),function(a){return a!=b}).join(" "))}
function pe(a,b,c){c?ne(a,b):oe(a,b)}
;var qe=x().toString();function re(a,b){this.J=p(a)?a:0;this.L=p(b)?b:0}
...
function Le(a){var b=Me.$c;return b?Ne(a,function(a){return!b||v(a.className)&&B(a.className.split(/\s+/),b)},!0,void 0):null}
...
function Te(a){a&&("string"==typeof a&&(a=[a]),z(a,function(a){if(a in hb){var c=hb[a],d=c[0],e=c[1],f=c[3],c=c[4];d.removeEventListener?d.removeEventListener(e,f,c):d.detachEvent&&d.detachEvent("on"+e,f);delete hb[a]}}))}
;function Ue(){if(null==r("_lact",window)){var a=parseInt(H("LACT"),10),a=isFinite(a)?x()-Math.max(a,0):-1;q("_lact",a,window);-1==a&&Ve();M(document,"keydown",Ve);M(document,"keyup",Ve);M(document,"mousedown",Ve);M(document,"mouseup",Ve);qc("page-mouse",Ve);qc("page-scroll",Ve);qc("page-resize",Ve)}}
function Ve(){null==r("_lact",window)&&(Ue(),r("_lact",window));var a=x();q("_lact",a,window);tc("USER_ACTIVE")}
function We(){var a=r("_lact",window);return null==a?-1:Math.max(x()-a,0)}
;function Xe(){}
Xe.prototype.set=u;Xe.prototype.get=u;Xe.prototype.remove=u;function Ye(){}
y(Ye,Xe);Ye.prototype.W=function(){var a=0;Mc(this.pa(!0),function(){a++});
return a};
Ye.prototype.pa=u;Ye.prototype.clear=function(){var a=Nc(this.pa(!0)),b=this;z(a,function(a){b.remove(a)})};function Ze(a){this.b=a}
y(Ze,Ye);g=Ze.prototype;g.isAvailable=function(){if(!this.b)return!1;try{return this.b.setItem("__sak","1"),this.b.removeItem("__sak"),!0}catch(a){return!1}};
...
g.pa=function(a){var b=0,c=this.b,d=new Kc;d.next=function(){if(b>=c.length)throw Jc;var d=c.key(b++);if(a)return d;d=c.getItem(d);if(!v(d))throw"Storage mechanism: Invalid value was encountered";return d};
return d};
g.clear=function(){this.b.clear()};
g.key=function(a){return this.b.key(a)};function $e(){var a=null;try{a=window.localStorage||null}catch(b){}this.b=a}
y($e,Ze);function af(){var a=null;try{a=window.sessionStorage||null}catch(b){}this.b=a}
y(af,Ze);function bf(a){this.b=a}
...
y(ff,cf);function gf(a){var b=a.creation;a=a.expiration;return!!a&&a<x()||!!b&&b>x()}
ff.prototype.set=function(a,b,c){if(b=ef(b)){if(c){if(c<x()){ff.prototype.remove.call(this,a);return}b.expiration=c}b.creation=x()}ff.C.set.call(this,a,b)};
...
y(hf,ff);function jf(a,b){var c=[];Mc(b,function(a){var b;try{b=hf.prototype.f.call(this,a,!0)}catch(f){if("Storage: Invalid value was encountered"==f)return;throw f;}p(b)?gf(b)&&c.push(a):c.push(a)},a);
return c}
function kf(a,b){var c=jf(a,b);z(c,function(a){hf.prototype.remove.call(this,a)},a)}
function lf(){var a=mf;kf(a,a.b.pa(!0))}
;function N(a,b,c){var d=c&&0<c?c:0;c=d?x()+1E3*d:0;if((d=d?mf:nf)&&window.JSON){v(b)||(b=JSON.stringify(b,void 0));try{d.set(a,b,c)}catch(e){d.remove(a)}}}
function of(a){if(!nf&&!mf||!window.JSON)return null;var b;try{b=nf.get(a)}catch(c){}if(!v(b))try{b=mf.get(a)}catch(c){}if(!v(b))return null;try{b=JSON.parse(b,void 0)}catch(c){}return b}
...
;function Tf(a,b,c){var d=H("EVENT_ID");d&&(b||(b={}),b.ei||(b.ei=d));if(b){var d=H("VALID_SESSION_TEMPDATA_DOMAINS",[]),e=Ed(Fd(3,window.location.href));e&&d.push(e);e=Ed(Fd(3,a));if(B(d,e)||!e&&0==a.lastIndexOf("/",0)){var f=a.match(Dd),d=f[5],e=f[6],f=f[7],h="";d&&(h+=d);e&&(h+="?"+e);f&&(h+="#"+f);d=h;e=d.indexOf("#");if(d=0>e?d:d.substr(0,e))Cd("enable_more_related_ve_logging")&&(b.itct||b.ved)&&(b.csn=b.csn||Mf()),d="ST-"+Ia(d).toString(36),e=b?Ld(b):"",Sf(d,e,5),b&&(b=b.itct||b.ved,d=r("yt.logging.screenreporter.storeParentElement"),
...
function og(a){var b=pg(a),c=document.getElementById(b),d=c&&D(c,"loaded");d||c&&!d||(c=qg(a,b,function(){D(c,"loaded")||(Ib(c,"loaded","true"),tc(b),I(na(wc,b),0))}))}
...
function pg(a){var b=document.createElement("a");Gb(b,a);a=b.href.replace(/^[a-zA-Z]+:\/\//,"//");return"css-"+Ia(a)}
...
y(yg,E);function zg(a,b,c,d){d=gc(w(d,a.f));b.addEventListener(c,d);a.b.push({target:b,name:c,Fb:d})}
...
function Dg(a,b,c){if(0==a.b){a===c&&(b=3,c=new TypeError("Promise cannot resolve to itself"));a.b=1;var d;a:{var e=c,f=a.T,h=a.G;if(e instanceof Cg)Og(e,Gg(f||t,h||null,a)),d=!0;else{var k;if(e)try{k=!!e.$goog_Thenable}catch(n){k=!1}else k=!1;if(k)e.then(f,h,a),d=!0;else{if(ha(e))try{var l=e.then;if(ga(l)){Qg(e,l,f,h,a);d=!0;break a}}catch(n){h.call(a,n);d=!0;break a}d=!1}}}d||(a.l=c,a.b=b,a.g=null,Pg(a),3!=b||c instanceof Kg||Rg(a,c))}}
...
function $g(a,b,c,d){var e={path:"/youtubei/"+a.b.innertubeApiVersion+"/"+b,headers:{"X-Goog-Visitor-Id":H("VISITOR_DATA")},method:"POST",body:L(c)},f=w(a.i,a);Yg.then(function(){f();r("gapi.client.request")(e).execute(d||t)})}
...
function ph(a,b,c){da(c)||(c=[String(c)]);qh(a.g,b,c)}
function rh(a){O(a,"zx",Math.floor(2147483648*Math.random()).toString(36)+Math.abs(Math.floor(2147483648*Math.random())^x()).toString(36));return a}
...
function ih(a,b,c){return v(a)?(a=encodeURI(a).replace(b,uh),c&&(a=a.replace(/%25([0-9a-fA-F]{2})/g,"%$1")),a):null}
...
g.X=function(a){vh(this);var b=[];if(v(a))yh(this,a)&&(b=Ua(b,this.b.get(xh(this,a))));else{a=this.b.X();for(var c=0;c<a.length;c++)b=Ua(b,a[c])}return b};
...
function Nh(a){var b=Lh();b&&(fa(a)&&(a=[a]),z(a,function(a){b.unsubscribeByKey(a);delete Ih[a]}))}
...
function bi(){var a=ci().info.yt_lt="hot_bg";Yh().info_yt_lt=a;if(Cd("csi_on_gel"))if("yt_lt"in Th){var b={},c=Th.yt_lt;B(Uh,c)&&(a=!!a);b[c]=a;a=Zh();b.clientActionNonce=a;ah("latencyActionInfo",b)}else hc(Error("Unknown label yt_lt logged with GEL CSI."))}
...
function ai(){var a=Xh(),b=ci().info,c=a._start,d;for(d in a)if(0==d.lastIndexOf("_",0)&&da(a[d])){var e=d.slice(1);if(e in Rh){var f=La(a[d],function(a){return Math.round(a-c)});
...
;var hi={"api.invalidparam":2,auth:150,"drm.auth":150,heartbeat:150,"html5.unsupportedads":5,"fmt.noneavailable":5,"fmt.decode":5,"fmt.unplayable":5,"html5.missingapi":5,"html5.unsupportedlive":5,"drm.unavailable":5};function ii(a,b){E.call(this);this.o=this.j=a;this.aa=b;this.B=!1;this.f={};this.La=this.$=null;this.ea=new G;$b(this,na(F,this.ea));this.i={};this.G=this.Ma=this.g=this.Ya=this.b=null;this.oa=!1;this.H=this.l=this.P=this.U=null;this.Na={};this.fd=["onReady"];this.ra=new yg(this);$b(this,na(F,this.ra));this.Eb=null;this.bc=NaN;this.va={};ji(this);this.sa("onDetailedError",w(this.Qd,this));this.sa("onTabOrderChange",w(this.kd,this));this.sa("onTabAnnounce",w(this.cc,this));this.sa("WATCH_LATER_VIDEO_ADDED",
w(this.Rd,this));this.sa("WATCH_LATER_VIDEO_REMOVED",w(this.Sd,this));sf||(this.sa("onMouseWheelCapture",w(this.Nd,this)),this.sa("onMouseWheelRelease",w(this.Od,this)));this.sa("onAdAnnounce",w(this.cc,this));this.K=new yg(this);$b(this,na(F,this.K));this.Xa=!1;this.Wa=null}
y(ii,E);var ki=["drm.unavailable","fmt.noneavailable","html5.missingapi","html5.unsupportedads","html5.unsupportedlive"];g=ii.prototype;g.Yb=function(a,b){this.D()||(li(this,a),mi(this,b),this.B&&ni(this))};
...
g.Be=function(){if(!this.oa){var a=si(this);a&&"html5"==ti(this)?(this.G="html5",this.B||this.Ra()):(ui(this),this.G="html5",a&&this.P?(this.j.appendChild(this.P),this.Ra()):(this.b.loaded=!0,this.U=w(function(){var a=this.j,c=this.b.clone();r("yt.player.Application.create")(a,c);this.Ra()},this),this.oa=!0,a?this.U():(xc(this.b.assets.js,this.U),mg(this.b.assets.css))))}};
...
this.i[e]);ni(this);this.Ma&&this.Ma(this.f);this.ea.w("onReady",this.f)}else this.bc=I(w(this.Ra,this),50)}};
...
function ji(a){a.B=!1;if(a.La)for(var b in a.i)a.La(b,a.i[b]);for(var c in a.va)J(parseInt(c,10));a.va={};a.$=null;a.La=null;for(var d in a.f)a.f[d]=null;a.f.addEventListener=w(a.sa,a);a.f.removeEventListener=w(a.ne,a);a.f.destroy=w(a.dispose,a);a.f.getLastError=w(a.td,a);a.f.getPlayerType=w(a.ud,a);a.f.getCurrentVideoConfig=w(a.sd,a);a.f.loadNewVideoConfig=w(a.Yb,a);a.f.isReady=w(a.Ne,a)}
g.Ne=function(){return this.B};
g.sa=function(a,b){if(!this.D()){var c=oi(this,b);if(c){if(!B(this.fd,a)&&!this.i[a]){var d=wi(this,a);this.$&&this.$(a,d)}this.ea.subscribe(a,c);"onReady"==a&&this.B&&I(na(c,this.f),0)}}};
...
g.A=function(){ui(this);if(this.P&&this.b)try{this.P.destroy()}catch(b){hc(b)}this.Na=null;for(var a in this.i)m[this.i[a]]=null;this.Ya=this.b=this.f=null;delete this.j;delete this.o;ii.C.A.call(this)};var xi={},yi="player_uid_"+(1E9*Math.random()>>>0);function zi(a,b){a=v(a)?ye(a):a;b=Yf(b);var c=yi+"_"+ia(a),d=xi[c];if(d)return d.Yb(b),d.f;d=new ii(a,c);xi[c]=d;tc("player-added",d.f);$b(d,na(Ai,d));I(function(){d.Yb(b)},0);
return d.f}
...
y(Li,P);function Mi(a){P.call(this,1,arguments);this.b=a}
y(Mi,P);function Ni(a,b,c,d){P.call(this,2,arguments);this.g=a;this.b=null===b?null:!!b;this.receivePostUpdates=null===c?null:!!c;this.f=null===d?null:!!d}
y(Ni,P);function Oi(a,b,c,d,e){P.call(this,2,arguments);this.f=a;this.b=b;this.i=c||null;this.g=d||null;this.source=e||null}
y(Oi,P);function Pi(a,b,c){P.call(this,1,arguments);this.b=a;this.subscriptionId=b}
y(Pi,P);function Qi(a,b,c,d,e,f,h){P.call(this,1,arguments);this.f=a;this.subscriptionId=b;this.b=c;this.j=d||null;this.i=e||null;this.g=f||null;this.source=h||null}
y(Qi,P);
...
function jj(a){z(arguments,function(a){!ea(a)||a instanceof Element?ij(a,!0):z(a,function(a){jj(a)})})}
function kj(a){z(arguments,function(a){!ea(a)||a instanceof Element?ij(a,!1):z(a,function(a){kj(a)})})}
...
function rj(a,b,c){var d=S(a,void 0),e=w(c,a);b in lj||(lj[b]=new G);lj[b].subscribe(d,e);a.g[c]=e}
...
y(uj,pj);ba(uj);g=uj.prototype;g.register=function(){rj(this,"mouseover",this.tb);rj(this,"mouseout",this.Ia);rj(this,"focus",this.lc);rj(this,"blur",this.gc);rj(this,"click",this.Ia);rj(this,"touchstart",this.Oc);rj(this,"touchend",this.Ab);rj(this,"touchcancel",this.Ab)};
...
g.tb=function(a){if(!(this.b&&1E3>x()-this.b)){var b=parseInt(D(a,"tooltip-hide-timer"),10);b&&(Kb(a,"tooltip-hide-timer"),J(b));var b=w(function(){vj(this,a);Kb(a,"tooltip-show-timer")},this),c=parseInt(D(a,"tooltip-show-delay"),10)||0,b=I(b,c);
Ib(a,"tooltip-show-timer",b.toString());a.title&&(tj(a,wj(a)),a.title="");b=ia(a).toString();this.f[b]=a}};
g.Ia=function(a){var b=parseInt(D(a,"tooltip-show-timer"),10);b&&(J(b),Kb(a,"tooltip-show-timer"));b=w(function(){if(a){var b=ye(xj(this,a));b&&(yj(b),b&&b.parentNode&&b.parentNode.removeChild(b),Kb(a,"content-id"));(b=ye(xj(this,a,"arialabel")))&&b.parentNode&&b.parentNode.removeChild(b)}Kb(a,"tooltip-hide-timer")},this);
b=I(b,50);Ib(a,"tooltip-hide-timer",b.toString());if(b=D(a,"tooltip-text"))a.title=b;b=ia(a).toString();delete this.f[b]};
...
g.Ab=function(a,b,c){c.changedTouches&&(this.b=x(),a=nj(b,S(this),c.changedTouches[0].target),this.Ia(a))};
...
y(Cj,pj);ba(Cj);Cj.prototype.register=function(){rj(this,"click",this.Hb);qj(this,Vi,this.uc);qj(this,Wi,this.tc);qj(this,Xi,this.$d);qj(this,$i,this.uc);qj(this,aj,this.tc);qj(this,bj,this.fe);qj(this,dj,this.Md);qj(this,ej,this.Ld)};
...
function Gj(a,b){var c=ze(S(a));return Ka(c,function(a){return b==D(a,"channel-external-id")},a)}
g.hd=function(a,b,c){var d=Ya(arguments,2);z(a,function(a){b.apply(this,Ua(a,d))},this)};
g.Oa=function(a,b,c){var d=Gj(this,a);this.hd.apply(this,Ua([d],Ya(arguments,1)))};
function Ej(a,b){var c=w(function(a){a.discoverable_subscriptions&&ec("SUBSCRIBE_EMBED_DISCOVERABLE_SUBSCRIPTIONS",a.discoverable_subscriptions);this.Hb(b)},a);
fj(c,"subscribe")}
...
function Ak(a,b,c,d){var e={path:"/youtubei/"+a.b.innertubeApiVersion+"/"+b,headers:{"X-Goog-Visitor-Id":H("VISITOR_DATA")},method:"POST",body:L(c)},f=w(a.i,a);yk.then(function(){f();r("gapi.client.request")(e).execute(d||t)})}
...
;function Dk(a,b,c){var d=[],e=[];if(1==(da(c)?2:1))return e=[b,a],z(d,function(a){e.push(a)}),Ek(e.join(" "));
...
function Hk(a,b,c){v(a)&&(a={mediaContentUrl:a,startSeconds:b,suggestedQuality:c});b=/\/([ve]|embed)\/([^#?]+)/.exec(a.mediaContentUrl);a.videoId=b&&b[2]?b[2]:null;return Ik(a)}
...
function Jk(a,b,c,d){if(ha(a)&&!da(a)){b="playlist list listType index startSeconds suggestedQuality".split(" ");c={};for(d=0;d<b.length;d++){var e=b[d];a[e]&&(c[e]=a[e])}return c}c={index:b,startSeconds:c,suggestedQuality:d};v(a)&&16==a.length?c.list="PL"+a:c.playlist=a;return c}
function Kk(a){var b=a.video_id||a.videoId;if(v(b)){var c=of("yt-player-two-stage-token")||{},d=of("yt-player-two-stage-token")||{};p(void 0)?d[b]=void 0:delete d[b];N("yt-player-two-stage-token",d,300);(b=c[b])&&(a.two_stage_token=b)}}
...
;var Zk=x(),$k=null,al=Array(50),bl=-1,cl=!1;function dl(){var a=el;fl();$k.push(a);gl($k)}
function hl(a,b){fl();var c=$k,d=il(a,String(b));0==c.length?jl(d):(gl(c),z(c,function(a){a(d)}))}
...
function gl(a){var b=al;if(b[0]){var c=bl,d=cl?c:-1;do{var d=(d+1)%50,e=b[d];z(a,function(a){a(e)})}while(d!=c);
al=Array(50);bl=-1;cl=!1}}
function il(a,b){var c=(x()-Zk)/1E3;c.toFixed&&(c=c.toFixed(3));var d=[];d.push("[",c+"s","] ");d.push("[","yt.mdx.remote","] ");d.push(a+": "+b,"\n");return d.join("")}
...
function ol(a){return da(a)?La(a,nl):[]}
function pl(a){return a?'{name:"'+a.name+'",id:'+a.id.substr(0,6)+"..,token:"+(a.token?".."+a.token.slice(-6):"-")+",uuid:"+(a.uuid?".."+a.uuid.slice(-6):"-")+"}":"null"}
function ql(a){return da(a)?"["+La(a,pl).join(",")+"]":"null"}
;var rl={Oe:"atp",Ye:"ska",Ve:"que",Te:"mus",Xe:"sus"};function sl(a){this.i=this.g="";this.b="/api/lounge";this.f=!0;a=a||document.location.href;var b=Number(Fd(4,a))||null||"";b&&(this.i=":"+b);this.g=Ed(Fd(3,a))||"";a=ob;0<=a.search("MSIE")&&(a=a.match(/MSIE ([\d.]+)/)[1],0>Ga(a,"10.0")&&(this.f=!1))}
...
function wl(a,b){return Pa(a,function(a){return a.key==b})}
function xl(a){return La(a,function(a){return{key:a.id,name:a.name}})}
function yl(a,b){return Pa(a,function(a){return a||b?!a!=!b?!1:a.id==b.id:!0})}
function zl(a,b){return Pa(a,function(a){return ll(a,b)})}
;function V(){E.call(this);this.o=new G;$b(this,na(F,this.o))}
y(V,E);V.prototype.subscribe=function(a,b,c){return this.D()?0:this.o.subscribe(a,b,c)};
...
y(Al,V);g=Al.prototype;g.ba=function(){return this.screens};
...
y(El,V);var Fl=[2E3,2E3,1E3,1E3,1E3,2E3,2E3,5E3,5E3,1E4];g=El.prototype;g.start=function(){!this.b&&isNaN(this.f)&&this.Fc()};
g.stop=function(){this.b&&(this.b.abort(),this.b=null);isNaN(this.f)||(J(this.f),this.f=NaN)};
g.A=function(){this.stop();El.C.A.call(this)};
g.Fc=function(){this.f=NaN;this.b=Wd(tl(this.B,"/pairing/get_screen"),{method:"POST",O:{pairing_code:this.l},timeout:5E3,R:w(this.Fe,this),onError:w(this.Ee,this),ka:w(this.Ge,this)})};
g.Fe=function(a,b){this.b=null;var c=b.screen||{};c.dialId=this.i;c.name=this.j;this.w("pairingComplete",new kl(c))};
g.Ee=function(a){this.b=null;a.status&&404==a.status?this.g>=Fl.length?this.w("pairingFailed",Error("DIAL polling timed out")):(a=Fl[this.g],this.f=I(w(this.Fc,this),a),this.g++):this.w("pairingFailed",Error("Server error "+a.status))};
g.Ge=function(){this.b=null;this.w("pairingFailed",Error("Server not responding"))};function Gl(a){this.app=this.name=this.id="";this.type="REMOTE_CONTROL";this.avatar=this.username="";this.capabilities=new Xc;this.experiments=new Xc;this.theme="u";if(a){this.id=a.id||a.name;this.name=a.name;this.app=a.app;this.type=a.type||"REMOTE_CONTROL";this.username=a.user||"";this.avatar=a.userAvatarUri||"";this.theme=a.theme||"u";var b=a.capabilities||"";this.capabilities.clear();Yc(this.capabilities,Ka(b.split(","),na(cb,rl)));a=a.experiments||"";this.experiments.clear();Yc(this.experiments,
a.split(","))}}
Gl.prototype.equals=function(a){return a?this.id==a.id:!1};var Hl;function Il(){var a=Jl(),b=Kl();B(a,b);if(Ll()){var c=a,d;d=0;for(var e=c.length,f;d<e;){var h=d+e>>1,k;k=Za(b,c[h]);0<k?d=h+1:(e=h,f=!k)}d=f?d:~d;0>d&&Xa(c,-(d+1),0,b)}a=Ml(a);if(0==a.length)try{Rf.remove("remote_sid","/","youtube.com")}catch(l){}else try{Sf("remote_sid",a.join(","),-1)}catch(l){}}
...
function Kl(){if(Ol)return Ol;var a=of("yt-remote-device-id");a||(a=vl(),N("yt-remote-device-id",a,31536E3));for(var b=Jl(),c=1,d=a;B(b,d);)c++,d=a+"#"+c;return Ol=d}
...
Oa(c,function(a){return!B(b,a)})&&Sl();
...
y(Wl,Al);g=Wl.prototype;g.start=function(){Xl(this)&&this.w("screenChange");!of("yt-remote-lounge-token-expiration")&&Yl(this);J(this.b);this.b=I(w(this.start,this),1E4)};
...
function Yl(a){if(a.screens.length){var b=La(a.screens,function(a){return a.id}),c=tl(a.f,"/pairing/get_lounge_token_batch");
ul(a.f,c,{screen_ids:b.join(",")},w(a.xd,a),w(a.wd,a))}}
...
function Xl(a){var b=ol(Rl()),b=Ka(b,function(a){return!a.uuid});
return Cl(a,b)}
function Zl(a,b){Ql(La(a.screens,ml));b&&Sl()}
;function $l(a,b){V.call(this);this.l=b;for(var c=of("yt-remote-online-screen-ids")||"",c=c?c.split(","):[],d={},e=this.l(),f=0,h=e.length;f<h;++f){var k=e[f].id;d[k]=B(c,k)}this.b=d;this.j=a;this.g=this.i=NaN;this.f=null;am("Initialized with "+L(this.b))}
y($l,V);g=$l.prototype;g.start=function(){var a=parseInt(of("yt-remote-fast-check-period")||"0",10);(this.i=x()-144E5<a?0:a)?bm(this):(this.i=x()+3E5,N("yt-remote-fast-check-period",this.i),this.Ub())};
...
cm(this,b)};
function dm(a,b,c){var d=tl(a.j,"/pairing/get_screen_availability");ul(a.j,d,{lounge_token:b.token},w(function(a){a=a.screens||[];for(var d=0,h=a.length;d<h;++d)if(a[d].loungeToken==b.token){c("online"==a[d].status);return}c(!1)},a),w(function(){c(!1)},a))}
...
function bm(a){isNaN(a.g)||J(a.g);a.g=I(w(a.Ub,a),0<a.i&&a.i<x()?2E4:1E4)}
g.Ub=function(){J(this.g);this.g=NaN;this.f&&this.f.abort();var a=fm(this);if(bb(a)){var b=tl(this.j,"/pairing/get_screen_availability");this.f=ul(this.j,b,{lounge_token:fb(a).join(",")},w(this.Yd,this,a),w(this.Xd,this))}else cm(this,{}),bm(this)};
g.Yd=function(a,b){this.f=null;var c;a:{c=fb(fm(this));var d=fb(a);if(ea(c)&&ea(d)&&c.length==d.length){for(var e=c.length,f=0;f<e;f++)if(c[f]!==d[f]){c=!1;break a}c=!0}else c=!1}if(c){c=b.screens||[];d={};e=0;for(f=c.length;e<f;++e)d[a[c[e].loungeToken]]="online"==c[e].status;cm(this,d);bm(this)}else this.N("Changing Screen set during request."),this.Ub()};
...
function fm(a){var b={};z(a.l(),function(a){a.token?b[a.token]=a.id:this.N("Requesting availability of screen w/o lounge token.")});
return b}
...
y(W,Al);g=W.prototype;g.start=function(){this.f.start();this.b.start();this.screens.length&&(this.w("screenChange"),this.b.isEmpty()||this.w("onlineScreenChange"))};
...
g.ba=function(a){return a?this.screens:Ua(this.screens,Ka(this.g,function(a){return!this.contains(a)},this))};
g.Qc=function(){return Ka(this.ba(!0),function(a){return!!this.b.b[a.id]},this)};
function hm(a,b,c,d,e,f){a.info("getAutomaticScreenByIds "+c+" / "+b);c||(c=a.i[b]);var h=a.ba();if(h=(c?zl(h,c):null)||zl(h,b)){h.uuid=b;var k=im(a,h);dm(a.b,k,function(a){e(a?k:null)})}else c?jm(a,c,w(function(a){var f=im(this,new kl({name:d,
screenId:c,loungeToken:a,dialId:b||""}));dm(this.b,f,function(a){e(a?f:null)})},a),f):e(null)}
g.Rc=function(a,b,c,d,e){this.info("getDialScreenByPairingCode "+a+" / "+b);var f=new El(this.j,a,b,c);f.subscribe("pairingComplete",w(function(a){F(f);d(im(this,a))},this));
...
g.Ie=function(a,b,c,d){Wd(tl(this.j,"/pairing/get_screen"),{method:"POST",O:{pairing_code:a},timeout:5E3,R:w(function(a,d){var h=new kl(d.screen||{});if(!h.name||km(this,h.name)){var k;a:{k=h.name;for(var l=2,n=b(k,l);km(this,n);){l++;if(20<l)break a;n=b(k,l)}k=n}h.name=k}c(im(this,h))},this),
onError:w(function(a){d(Error("pairing request failed: "+a.status))},this),
ka:w(function(){d(Error("pairing request timed out."))},this)})};
...
function gm(a){mm(a);a.f=new Wl(a.j);a.f.subscribe("screenChange",w(a.yd,a));lm(a);a.g=ol(of("yt-remote-automatic-screen-cache")||[]);mm(a);a.info("Initializing automatic screens: "+ql(a.g));a.b=new $l(a.j,w(a.ba,a,!0));a.b.subscribe("screenChange",w(function(){this.w("onlineScreenChange")},a))}
function im(a,b){var c=a.get(b.id);c?(c.uuid=b.uuid,b=c):((c=zl(a.g,b.uuid))?(c.id=b.id,c.token=b.token,b=c):a.g.push(b),N("yt-remote-automatic-screen-cache",La(a.g,ml)));mm(a);a.i[b.uuid]=b.id;N("yt-remote-device-id-map",a.i,31536E3);return b}
...
y(nm,V);g=nm.prototype;g.vb=function(a){this.g=a;this.w("sessionScreen",this.g)};
...
g.stop=u;g.Vb=function(a){var b=this.b;a?(b.displayStatus=new chrome.cast.ReceiverDisplayStatus(a,[]),b.displayStatus.showStop=!0):b.displayStatus=null;chrome.cast.setReceiverDisplayStatus(b,w(function(){this.info("Updated receiver status for "+b.friendlyName+": "+a)},this),w(function(){om(this,"Failed to update receiver status for: "+b.friendlyName)},this))};
g.A=function(){this.Vb("");nm.C.A.call(this)};function pm(a,b){nm.call(this,a,b,"CastSession");this.f=null;this.i=0;this.l=w(this.Je,this);this.j=w(this.ie,this);this.i=I(w(function(){qm(this,null)},this),12E4)}
y(pm,nm);g=pm.prototype;g.zb=function(a){if(this.f){if(this.f==a)return;om(this,"Overriding cast sesison with new session object");this.f.removeUpdateListener(this.l);this.f.removeMessageListener("urn:x-cast:com.google.youtube.mdx",this.j)}this.f=a;this.f.addUpdateListener(this.l);this.f.addMessageListener("urn:x-cast:com.google.youtube.mdx",this.j);rm(this)};
g.Ha=function(a){this.info("launchWithParams no-op for Cast: "+L(a))};
g.stop=function(){this.f?this.f.stop(w(function(){this.ca()},this),w(function(){this.ca(Error("Failed to stop receiver app."))},this)):this.ca(Error("Stopping cast device witout session."))};
...
function rm(a){a.info("sendYoutubeMessage_: getMdxSessionStatus "+L(void 0));var b={type:"getMdxSessionStatus"};a.f?a.f.sendMessage("urn:x-cast:com.google.youtube.mdx",b,t,w(function(){om(this,"Failed to send message: getMdxSessionStatus.")},a)):om(a,"Sending yt message without session: "+L(b))}
...
function qm(a,b){J(a.i);if(b){if(a.info("onConnectedScreenId_: Received screenId: "+b),!a.g||a.g.id!=b){var c=w(a.vb,a),d=w(a.ca,a);a.nc(b,c,d,5)}}else a.ca(Error("Waiting for session status timed out."))}
g.nc=function(a,b,c,d){hm(this.H,this.b.label,a,this.b.friendlyName,w(function(e){e?b(e):0<=d?(om(this,"Screen "+a+" appears to be offline. "+d+" retries left."),I(w(this.nc,this,a,b,c,d-1),300)):c(Error("Unable to fetch screen."))},this),c)};
g.Tc=function(){return this.f};
g.Je=function(a){this.D()||a||(om(this,"Cast session died."),this.ca())};function sm(a,b){nm.call(this,a,b,"DialSession");this.i=this.G=null;this.K="";this.j=null;this.B=t;this.l=NaN;this.P=w(this.Me,this);this.f=t}
y(sm,nm);g=sm.prototype;g.zb=function(a){this.i=a;this.i.addUpdateListener(this.P)};
g.Ha=function(a){this.j=a;this.B()};
g.stop=function(){this.f();this.f=t;J(this.l);this.i?this.i.stop(w(this.ca,this,null),w(this.ca,this,"Failed to stop DIAL device.")):this.ca()};
g.A=function(){this.f();this.f=t;J(this.l);this.i&&this.i.removeUpdateListener(this.P);this.i=null;sm.C.A.call(this)};
function tm(a){a.f=a.H.Rc(a.K,a.b.label,a.b.friendlyName,w(function(a){this.f=t;this.vb(a)},a),w(function(a){this.f=t;
this.ca(a)},a))}
...
g.Rb=function(a){this.K=vl();if(this.j){var b=new chrome.cast.DialLaunchResponse(!0,um(this));a(b);tm(this)}else this.B=w(function(){J(this.l);this.B=t;this.l=NaN;var b=new chrome.cast.DialLaunchResponse(!0,um(this));a(b);tm(this)},this),this.l=I(w(function(){this.B()},this),100)};
g.zd=function(a,b){hm(this.H,this.G.receiver.label,a,this.b.friendlyName,w(function(a){a&&a.token?(this.vb(a),b(new chrome.cast.DialLaunchResponse(!1))):this.Rb(b)},this),w(function(a){om(this,"Failed to get DIAL screen: "+a);
this.Rb(b)},this))};function vm(a,b){nm.call(this,a,b,"ManualSession");this.f=I(w(this.Ha,this,null),150)}
y(vm,nm);vm.prototype.stop=function(){this.ca()};
...
vm.prototype.A=function(){J(this.f);this.f=NaN;vm.C.A.call(this)};function X(a){V.call(this);this.f=a;this.b=null;this.j=!1;this.g=[];this.i=w(this.Vd,this)}
y(X,V);g=X.prototype;
g.init=function(a,b){chrome.cast.timeout.requestSession=3E4;var c=new chrome.cast.SessionRequest("233637DE");c.dialRequest=new chrome.cast.DialRequest("YouTube");var d=chrome.cast.AutoJoinPolicy.TAB_AND_ORIGIN_SCOPED,e=a?chrome.cast.DefaultActionPolicy.CAST_THIS_TAB:chrome.cast.DefaultActionPolicy.CREATE_SESSION,c=new chrome.cast.ApiConfig(c,w(this.zc,this),w(this.Wd,this),d,e);c.customDialLaunchCallback=w(this.Kd,this);chrome.cast.initialize(c,w(function(){this.D()||(chrome.cast.addReceiverActionListener(this.i),dl(),
this.f.subscribe("onlineScreenChange",w(this.Sc,this)),this.g=wm(this),chrome.cast.setCustomReceivers(this.g,t,w(function(a){this.N("Failed to set initial custom receivers: "+L(a))},this)),this.w("yt-remote-cast2-availability-change",xm(this)),b(!0))},this),w(function(a){this.N("Failed to initialize API: "+L(a));
b(!1)},this))};
...
t,w(function(a){this.N("Failed to set initial custom receivers: "+L(a))},this)));
...
function zm(a,b){return b?Pa(a.g,function(a){return ll(b,a.label)},a):null}
...
g.requestSession=function(){chrome.cast.requestSession(w(this.zc,this),w(this.Zd,this))};
g.A=function(){this.f.unsubscribe("onlineScreenChange",w(this.Sc,this));window.chrome&&chrome.cast&&chrome.cast.removeReceiverActionListener(this.i);var a=el,b=r("yt.mdx.remote.debug.handlers_");Sa(b||[],a);F(this.b);X.C.A.call(this)};
...
function Am(a,b,c){F(a.b);(a.b=b)?(c?a.w("yt-remote-cast2-receiver-resumed",b.b):a.w("yt-remote-cast2-receiver-selected",b.b),b.subscribe("sessionScreen",w(a.Ac,a,b)),b.g?a.w("yt-remote-cast2-session-change",b.g):c&&a.b.Ha(null)):a.w("yt-remote-cast2-session-change",null)}
...
chrome.cast.ReceiverType.CAST&&(ym("onSessionEstablished_: manual to cast session change "+b.friendlyName),F(this.b),this.b=new pm(this.f,b),this.b.subscribe("sessionScreen",w(this.Ac,this,this.b)),this.b.Ha(null));this.b.zb(a)}}};
...
function wm(a){var b=a.f.Qc(),c=a.b&&a.b.b;a=La(b,function(a){c&&ll(a,c.label)&&(c=null);var b=a.uuid?a.uuid:a.id,f=zm(this,a);f?(f.label=b,f.friendlyName=a.name):(f=new chrome.cast.Receiver(b,a.name),f.receiverType=chrome.cast.ReceiverType.CUSTOM);return f},a);
c&&(c.receiverType!=chrome.cast.ReceiverType.CUSTOM&&(c=new chrome.cast.Receiver(c.label,c.friendlyName),c.receiverType=chrome.cast.ReceiverType.CUSTOM),a.push(c));return a}
g.Sc=function(){if(!this.D()){var a=xm(this);this.g=wm(this);ym("Updating custom receivers: "+L(this.g));chrome.cast.setCustomReceivers(this.g,t,w(function(){this.N("Failed to set custom receivers.")},this));
...
function Pm(){var a=of("yt-remote-cast-receiver");a?(a=a.friendlyName,a=-1!=a.indexOf("&")?"document"in m?Aa(a):Da(a):a):a=null;return a}
...
Bn.prototype.parse=function(a){return this.b(a)};function Cn(a,b){yn.call(this);this.b=a||1;this.f=b||m;this.i=w(this.ze,this);this.j=x()}
y(Cn,yn);g=Cn.prototype;g.enabled=!1;g.fa=null;function Dn(a,b){a.b=b;a.fa&&a.enabled?(a.stop(),a.start()):a.fa&&a.stop()}
g.ze=function(){if(this.enabled){var a=x()-this.j;0<a&&a<.8*this.b?this.fa=this.f.setTimeout(this.i,this.b-a):(this.fa&&(this.f.clearTimeout(this.fa),this.fa=null),zn(this,"tick"),this.enabled&&(this.fa=this.f.setTimeout(this.i,this.b),this.j=x()))}};
g.start=function(){this.enabled=!0;this.fa||(this.fa=this.f.setTimeout(this.i,this.b),this.j=x())};
...
function En(a,b,c){if(ga(a))c&&(a=w(a,c));else if(a&&"function"==typeof a.handleEvent)a=w(a.handleEvent,a);else throw Error("Invalid listener argument");return 2147483647<Number(b)?-1:m.setTimeout(a,b||0)}
;function Fn(a,b,c){E.call(this);this.i=null!=c?w(a,c):a;this.g=b;this.f=w(this.ae,this);this.b=[]}
y(Fn,E);g=Fn.prototype;g.Ta=!1;g.gb=0;g.Ea=null;g.qd=function(a){this.b=arguments;this.Ea||this.gb?this.Ta=!0:Gn(this)};
...
y(Hn,E);var In=[];Hn.prototype.sb=function(a,b,c,d){da(b)||(b&&(In[0]=b.toString()),b=In);for(var e=0;e<b.length;e++){var f=nn(a,b[e],c||this.handleEvent,d||!1,this.f||this);if(!f)break;this.b[f.key]=f}return this};
Hn.prototype.Bb=function(a,b,c,d,e){if(da(b))for(var f=0;f<b.length;f++)this.Bb(a,b[f],c,d,e);else c=c||this.handleEvent,e=e||this.f||this,c=on(c),d=!!d,b=a&&a[an]?jn(a.g,String(b),c,d,e):a?(a=pn(a))?jn(a,b,c,d,e):null:null,b&&(un(b),delete this.b[b.key]);return this};
...
y(Nn,Kn);Nn.prototype.b=function(){var a=On(this);return a?new ActiveXObject(a):new XMLHttpRequest};
...
function Tn(a,b){a.hb=x();Vn(a);a.za=a.wa.clone();ph(a.za,"t",a.l);a.kb=0;a.S=a.b.Ib(a.b.ib()?b:null);0<a.Pb&&(a.xb=new Fn(w(a.Pc,a,a.S),a.Pb));a.i.sb(a.S,"readystatechange",a.le);var c=a.Fa?kb(a.Fa):{};a.Ja?(a.Db="POST",c["Content-Type"]="application/x-www-form-urlencoded",a.S.send(a.za,a.Db,a.Ja,c)):(a.Db="GET",a.Kc&&!hd&&(c.Connection="close"),a.S.send(a.za,a.Db,null,c));a.b.ja(1)}
...
function eo(a,b){a.hb=x();Vn(a);var c=b?window.location.hostname:"";a.za=a.wa.clone();O(a.za,"DOMAIN",c);O(a.za,"t",a.l);try{a.ma=new ActiveXObject("htmlfile")}catch(n){Zn(a);a.Ga=7;Y();bo(a);return}var d="<html><body>";if(b){for(var e="",f=0;f<c.length;f++){var h=c.charAt(f);if("<"==h)e+="\\x3c";else if(">"==h)e+="\\x3e";else{if(h in Fa)h=Fa[h];else if(h in Ea)h=Fa[h]=Ea[h];else{var k,l=h.charCodeAt(0);if(31<l&&127>l)k=h;else{if(256>l){if(k="\\x",16>l||256<l)k+="0"}else k="\\u",4096>l&&(k+="0");
k+=l.toString(16).toUpperCase()}h=Fa[h]=k}e+=h}}d+='<script>document.domain="'+e+'"\x3c/script>'}c=Fb(d+"</body></html>");a.ma.open();a.ma.write(Eb(c));a.ma.close();a.ma.parentWindow.m=w(a.ee,a);a.ma.parentWindow.d=w(a.Dc,a,!0);a.ma.parentWindow.rpcClose=w(a.Dc,a,!1);c=a.ma.createElement("DIV");a.ma.parentWindow.document.body.appendChild(c);d=yb(a.za.toString());d=wb(d);za.test(d)&&(-1!=d.indexOf("&")&&(d=d.replace(ta,"&amp;")),-1!=d.indexOf("<")&&(d=d.replace(ua,"&lt;")),-1!=d.indexOf(">")&&(d=d.replace(va,
...
g.ee=function(a){fo(w(this.de,this,a),0)};
g.de=function(a){this.Ba||(Yn(this),ao(this,a),Vn(this))};
g.Dc=function(a){fo(w(this.ce,this,a),0)};
g.ce=function(a){this.Ba||(Zn(this),this.la=a,this.b.ub(this),this.b.ja(4))};
g.cancel=function(){this.Ba=!0;Zn(this)};
function Vn(a){a.Xb=x()+a.j;go(a,a.j)}
function go(a,b){if(null!=a.Va)throw Error("WatchDog timer not null");a.Va=fo(w(a.ge,a),b)}
function Yn(a){a.Va&&(m.clearTimeout(a.Va),a.Va=null)}
g.ge=function(){this.Va=null;var a=x();0<=a-this.Xb?(2!=this.Ua&&this.b.ja(3),Zn(this),this.Ga=2,Y(),bo(this)):go(this,this.Xb-a)};
...
g=lo.prototype;g.Nb=null;g.da=null;g.yb=!1;g.Nc=null;g.ob=null;g.Sb=null;g.Ob=null;g.ga=null;g.ua=-1;g.cb=null;g.Za=null;g.connect=function(a){this.Ob=a;a=mo(this.b,null,this.Ob);Y();this.Nc=x();var b=this.b.B;null!=b?(this.cb=b[0],(this.Za=b[1])?(this.ga=1,no(this)):(this.ga=2,oo(this))):(ph(a,"MODE","init"),this.da=new Pn(this,0,void 0,void 0,void 0),this.da.Fa=this.Nb,Un(this.da,a,!1,null,!0),this.ga=0)};
function no(a){var b=mo(a.b,a.Za,"/mail/images/cleardot.gif");rh(b);io(b.toString(),5E3,w(a.ld,a),3,2E3);a.ja(1)}
...
g.yc=function(a,b){this.ua=a.eb;if(0==this.ga)if(b){try{var c=this.f.parse(b)}catch(d){c=this.b;c.ia=this.ua;po(c,2);return}this.cb=c[0];this.Za=c[1]}else c=this.b,c.ia=this.ua,po(c,2);else if(2==this.ga)if(this.yb)Y(),this.Sb=x();else if("11111"==b){if(Y(),this.yb=!0,this.ob=x(),c=this.ob-this.Nc,!K||qd(10)||500>c)this.ua=200,this.da.cancel(),Y(),qo(this.b,this,!0)}else Y(),this.ob=this.Sb=x(),this.yb=!1};
...
y(ro,yn);var so=/^https?$/i,to=["POST","PUT"];g=ro.prototype;
g.send=function(a,b,c,d){if(this.b)throw Error("[goog.net.XhrIo] Object is active with another request="+this.$+"; newUri="+a);b=b?b.toUpperCase():"GET";this.$=a;this.o="";this.j=0;this.P=!1;this.f=!0;this.b=this.K?this.K.b():Mn.b();this.H=this.K?Ln(this.K):Ln(Mn);this.b.onreadystatechange=w(this.xc,this);try{this.getStatus(),this.U=!0,this.b.open(b,String(a),!0),this.U=!1}catch(f){this.getStatus();uo(this,f);return}a=c||"";var e=this.headers.clone();d&&Vc(d,function(a,b){e.set(b,a)});
d=Pa(e.qa(),vo);c=m.FormData&&a instanceof m.FormData;!B(to,b)||d||c||e.set("Content-Type","application/x-www-form-urlencoded;charset=utf-8");e.forEach(function(a,b){this.b.setRequestHeader(b,a)},this);
this.ra&&(this.b.responseType=this.ra);"withCredentials"in this.b&&this.b.withCredentials!==this.oa&&(this.b.withCredentials=this.oa);try{wo(this),0<this.G&&(this.ea=xo(this.b),this.getStatus(),this.ea?(this.b.timeout=this.G,this.b.ontimeout=w(this.oc,this)):this.B=En(this.oc,this.G,this)),this.getStatus(),this.l=!0,this.b.send(a),this.l=!1}catch(f){this.getStatus(),uo(this,f)}};
function xo(a){return K&&pd(9)&&fa(a.timeout)&&p(a.ontimeout)}
...
function wo(a){a.b&&a.ea&&(a.b.ontimeout=null);fa(a.B)&&(m.clearTimeout(a.B),a.B=null)}
...
y(Eo,Xm);function Fo(a,b){Xm.call(this,"timingevent",a);this.size=b}
y(Fo,Xm);function Go(a){Xm.call(this,"serverreachability",a)}
y(Go,Xm);g=Bo.prototype;g.connect=function(a,b,c,d,e){Y();this.Mb=b;this.ab=c||{};d&&p(e)&&(this.ab.OSID=d,this.ab.OAID=e);this.xa=new lo(this);this.xa.Nb=null;this.xa.f=this.j;this.xa.connect(a)};
function Ho(a){Io(a);if(3==a.b){var b=a.fb++,c=a.pb.clone();O(c,"SID",a.g);O(c,"RID",b);O(c,"TYPE","terminate");Jo(a,c);b=new Pn(a,0,a.g,b,void 0);b.Ua=2;b.wa=rh(c.clone());(new Image).src=b.wa;b.hb=x();Vn(b)}Ko(a)}
...
function No(a){a.Z||a.ya||(a.ya=fo(w(a.Cc,a),0),a.bb=0)}
...
return c.join("&")}
function Ro(a){a.M||a.ta||(a.o=1,a.ta=fo(w(a.Bc,a),0),a.Pa=0)}
function So(a){if(a.M||a.ta||3<=a.Pa)return!1;a.o++;a.ta=fo(w(a.Bc,a),To(a,a.Pa));a.Pa++;return!0}
...
g.ub=function(a){var b;if(this.M==a)Lo(this),this.M=null,b=2;else if(this.Z==a)this.Z=null,b=1;else return;this.ia=a.eb;if(0!=this.b)if(a.la)1==b?(x(),zn(Do,new Fo(Do,a.Ja?a.Ja.length:0)),No(this),this.i.length=0):Ro(this);else{var c=a.Ga,d;if(!(d=3==c||7==c||0==c&&0<this.ia)){if(d=1==b)this.Z||this.ya||1==this.b||2<=this.bb?d=!1:(this.ya=fo(w(this.Cc,this,a),To(this,this.bb)),this.bb++,d=!0);d=!(d||2==b&&So(this))}if(d)switch(c){case 1:po(this,5);break;case 4:po(this,10);break;case 3:po(this,6);
...
g.pd=function(a){if(!B(arguments,this.b))throw Error("Unexpected channel state: "+this.b);};
function po(a,b){if(2==b||9==b){var c=null;a.V&&(c=null);var d=w(a.ye,a);c||(c=new bh("//www.google.com/images/cleardot.gif"),rh(c));jo(c.toString(),1E4,d)}else Y();Uo(a,b)}
...
function fo(a,b){if(!ga(a))throw Error("Fn must not be null and must be a function");return m.setTimeout(function(){a()},b)}
...
g.isActive=function(){return!0};function Wo(a,b){Cn.call(this);this.o=0;if(ga(a))b&&(a=w(a,b));else if(a&&ga(a.handleEvent))a=w(a.handleEvent,a);else throw Error("Invalid listener argument");this.B=a;nn(this,"tick",w(this.l,this));Xo(this)}
y(Wo,Cn);Wo.prototype.l=function(){if(500<this.b){var a=this.b;24E4>2*a&&(a*=2);Dn(this,a)}this.B()};
Wo.prototype.start=function(){Wo.C.start.call(this);this.o=x()+this.b};
...
y(Yo,Vo);g=Yo.prototype;g.subscribe=function(a,b,c){return this.g.subscribe(a,b,c)};
...
function dp(a){a.audioTrackId=null;a.g=null;a.b=-1;a.f=0;a.i=x()}
...
function ep(a){switch(a.b){case 1:return(x()-a.i)/1E3+a.f;case -1E3:return 0}return a.f}
...
function ip(a){a.i=I(w(function(){hp("Connecting timeout");this.j(1)},a),2E4)}
function kp(a){J(a.i);a.i=NaN}
function mp(a){J(a.U);a.U=NaN}
function np(a){lp(a);a.P=I(w(function(){op(this,"getNowPlaying")},a),2E4)}
function lp(a){J(a.P);a.P=NaN}
g.Jd=function(){hp("Channel opened");this.$&&(this.$=!1,mp(this),this.U=I(w(function(){hp("Timing out waiting for a screen.");this.j(1)},this),15E3));
Tl($o(this.b),this.oa)};
...
function up(a,b){var c=parseInt(b.params.currentTime||b.params.current_time,10),d=a.F;d.f=isNaN(c)?0:c;d.i=x();c=parseInt(b.params.state,10);c=isNaN(c)?-1:c;-1==c&&-1E3==a.F.b&&(c=-1E3);a.F.b=c;1==a.F.b?np(a):lp(a);a.w("remotePlayerChange")}
function vp(a,b){var c="true"==b.params.muted;a.F.volume=parseInt(b.params.volume,10);a.F.j=c;a.w("remotePlayerChange")}
g.Id=function(a){a.params?hp("Received: action="+a.action+", params="+L(a.params)):hp("Received: action="+a.action+" {}");switch(a.action){case "loungeStatus":a=ud(a.params.devices);this.f=La(a,function(a){return new Gl(a)});
a=!!Pa(this.f,function(a){return"LOUNGE_SCREEN"==a.type});
...
pp(this,!1);break;case "remoteConnected":var b=new Gl(ud(a.params.device));Pa(this.f,function(a){return a.equals(b)})||Ra(this.f,b);
...
Z.prototype.getPlayerContextData=Z.prototype.La;Z.prototype.Wa=function(a){var b=new cp(a);b.videoId&&b.videoId!=this.F.videoId&&(this.g=b.videoId,J(this.H),this.H=I(w(this.oe,this),5E3));var c=[];this.F.listId==b.listId&&this.F.videoId==b.videoId&&this.F.index==b.index||c.push("remoteQueueChange");this.F.b==b.b&&this.F.volume==b.volume&&this.F.j==b.j&&ep(this.F)==ep(b)&&L(this.F.g)==L(b.g)||c.push("remotePlayerChange");this.F.reset(a);z(c,function(a){this.w(a)},this)};
Z.prototype.setPlayerContextData=Z.prototype.Wa;Z.prototype.ea=function(){var a=this.b.o.id,b=Pa(this.f,function(b){return"REMOTE_CONTROL"==b.type&&b.id!=a});
return b?b.id:""};
Z.prototype.getOtherConnectedRemoteId=Z.prototype.ea;Z.prototype.l=function(){var a=this.b;return a.f.enabled?a.f.o-x():NaN};
...
Z.prototype.reconnect=Z.prototype.Ya;function qp(a){J(a.K);a.K=I(w(a.j,a,1),864E5)}
...
Z.prototype.sendMessage=Z.prototype.Na;function wp(a){Al.call(this,"ScreenServiceProxy");this.Y=a;this.b=[];this.b.push(this.Y.$_s("screenChange",w(this.He,this)));this.b.push(this.Y.$_s("onlineScreenChange",w(this.Pd,this)))}
y(wp,Al);g=wp.prototype;g.ba=function(a){return this.Y.$_gs(a)};
...
function Lp(){sc(Ep);Ep.length=0;F(Mp);Mp=null;zp&&(z(zp,function(a){a(null)}),zp.length=0,zp=null,q("yt.mdx.remote.deferredProxies_",null,void 0));
yp=null}
...
function Tp(){var a=Qp(),b=Rp();b||(b=Hp());return Pa(a,function(a){return b&&ll(b,a.key)?!0:!1})}
...
function Xp(a){var b=Op();Fp(null);a?Op():Yp("");q("yt.mdx.remote.connection_",a,void 0);zp&&(z(zp,function(b){b(a)}),zp.length=0);
...
y(nq,E);g=nq.prototype;g.start=function(){this.i||this.D()||(this.i=!0,oq(this.f,"RECEIVING"))};
g.Uc=u;g.addEventListener=u;g.removeEventListener=u;g.Hc=function(a,b){if(this.i&&!this.D()){var c=b||{};switch(a){case "addEventListener":if(v(c.event)&&(c=c.event,!(c in this.g))){var d=w(this.qe,this,c);this.g[c]=d;this.addEventListener(c,d)}break;case "removeEventListener":v(c.event)&&pq(this,c.event);break;default:this.Uc(a,b)}}};
...
y(qq,nq);g=qq.prototype;g.addEventListener=function(a,b){this.b.addEventListener(a,b)};
...
g.A=function(){qq.C.A.call(this);delete this.b};function tq(a,b,c,d){E.call(this);this.b=b||null;this.B="*";this.i=c||null;this.f=null;this.channel=d||null;this.H=!!a;this.G=w(this.K,this);window.addEventListener("message",this.G)}
y(tq,E);tq.prototype.K=function(a){if(!("*"!=this.i&&a.origin!=this.i||this.b&&a.source!=this.b)&&v(a.data)){var b;try{b=ud(a.data)}catch(c){return}null!=b&&(this.H&&(this.f&&this.f!=b.id||this.channel&&this.channel!=b.channel)?window.console&&window.console.warn("Session ID or channel missmatch"):b&&this.l(a,b))}};
...
y(uq,tq);uq.prototype.l=function(a,b){switch(b.event){case "listening":"null"!=a.origin?this.i=this.B=a.origin:hc(Error("MessageEvent origin is null"),"WARNING");this.b=a.source;this.f=b.id;this.g&&(this.g(),this.g=null);break;case "command":this.j&&(this.o&&!B(this.o,b.func)||this.j(b.func,b.args))}};function vq(){var a=this.f=new uq(!!H("WIDGET_ID_ENFORCE")),b=w(this.me,this);a.j=b;a.o=null;this.f.channel="widget";if(a=H("WIDGET_ID"))this.f.P=a;this.i=[];this.o=!1;this.j={}}
...
g.Vc=function(){};
function wq(a,b){return w(function(a){this.sendMessage(b,a)},a)}
g.addEventListener=function(){};
g.rd=function(){this.o=!0;this.sendMessage("initialDelivery",this.Kb());this.sendMessage("onReady");z(this.i,this.Wc,this);this.i=[]};
...
g.dispose=function(){this.f=null};function yq(a){vq.call(this);this.b=a;this.g=[];this.addEventListener("onReady",w(this.Ud,this));this.addEventListener("onVideoProgress",w(this.ue,this));this.addEventListener("onVolumeChange",w(this.ve,this));this.addEventListener("onApiChange",w(this.pe,this));this.addEventListener("onPlaybackQualityChange",w(this.re,this));this.addEventListener("onPlaybackRateChange",w(this.se,this));this.addEventListener("onStateChange",w(this.te,this))}
y(yq,vq);g=yq.prototype;g.Vc=function(a,b){if(this.b[a]){b=b||[];if(0<b.length&&Gk(a)){var c;c=b;if(ha(c[0])&&!da(c[0]))c=c[0];else{var d={};switch(a){case "loadVideoById":case "cueVideoById":d=Ik.apply(window,c);break;case "loadVideoByUrl":case "cueVideoByUrl":d=Hk.apply(window,c);break;case "loadPlaylist":case "cuePlaylist":d=Jk.apply(window,c)}c=d}Kk(c);b.length=1;b[0]=c}this.b[a].apply(this.b,b);Gk(a)&&xq(this,this.Kb())}};
g.Ud=function(){var a=w(this.rd,this);this.f.g=a};
g.addEventListener=function(a,b){this.g.push({eventType:a,listener:b});this.b.addEventListener(a,b)};
g.Kb=function(){if(!this.b)return null;var a=this.b.getApiInterface();Sa(a,"getVideoData");for(var b={apiInterface:a},c=0,d=a.length;c<d;c++){var e=a[c],f=e;if(0==f.search("get")||0==f.search("is")){var f=e,h=0;0==f.search("get")?h=3:0==f.search("is")&&(h=2);f=f.charAt(h).toLowerCase()+f.substr(h+1);try{var k=this.b[e]();b[f]=k}catch(l){}}}b.videoData=this.b.getVideoData();b.currentTimeLastUpdated_=x()/1E3;return b};
...
g.ue=function(a){a={currentTime:a,videoBytesLoaded:this.b.getVideoBytesLoaded(),videoLoadedFraction:this.b.getVideoLoadedFraction(),currentTimeLastUpdated_:x()/1E3,playbackRate:this.b.getPlaybackRate()};this.b.getProgressState&&(a.progressState=this.b.getProgressState());xq(this,a)};
...
y(zq,V);function oq(a,b,c){if(!a.D()){var d=a.b;d.D()||a.f!=d.b||(a={id:a.g,command:b},c&&(a.data=c),d.b.postMessage(L(a),d.g))}}
zq.prototype.A=function(){this.f=this.b=null;zq.C.A.call(this)};function Aq(a,b,c){E.call(this);this.b=a;this.g=c;this.i=M(window,"message",w(this.j,this));this.f=new zq(this,a,b);$b(this,na(F,this.f))}
y(Aq,E);Aq.prototype.j=function(a){var b;if(b=!this.D())if(b=a.origin==this.g)a:{b=this.b;do{var c;b:{c=a.source;do{if(c==b){c=!0;break b}if(c==c.parent)break;c=c.parent}while(null!=c);c=!1}if(c){b=!0;break a}b=b.opener}while(null!=b);b=!1}if(b&&(a=a.data,v(a))){try{a=ud(a)}catch(d){return}a.command&&(b=this.f,b.D()||b.w("command",a.command,a.data))}};
...
function Kq(a,b){I(function(){var a=w(Lq,m,b),a=Eq().then(Iq,a);Jg(a,null,t,void 0)},a)}
...
y(Tq,P);function Uq(a,b){P.call(this,2,arguments);this.f=a;this.b=b}
y(Uq,P);function Vq(a,b,c,d){P.call(this,1,arguments);this.b=b;this.f=c||null;this.itemId=d||null}
y(Vq,P);function Wq(a,b){P.call(this,1,arguments);this.f=a;this.b=b||null}
y(Wq,P);function Xq(a){P.call(this,1,arguments)}
y(Xq,P);var Yq=new Q("ypc-core-load",Tq),Zq=new Q("ypc-guide-sync-success",Uq),$q=new Q("ypc-purchase-success",Vq),ar=new Q("ypc-subscription-cancel",Xq),br=new Q("ypc-subscription-cancel-success",Wq),cr=new Q("ypc-init-subscription",Xq);var dr=!1,er=[],fr=[];function gr(a){a.b?dr?R(Yi,a):R(Yq,new Tq(function(){R(cr,new Xq(a.b))})):hr(a.f,a.i,a.g,a.source)}
...
Wd("/subscription_ajax?action_create_subscription_to_all=1",{method:"POST",O:c,R:function(c,f){d();var h=f.response,k=h.id;if(da(k)&&k.length==b.length){var l=h.channel_info_map;z(k,function(a,c){var d=b[c];R(Xi,new Pi(d,a,l[d]))});
...
onError:function(){d()}})}}
function ur(a,b){z(a,function(a){R(b,new Mi(a))})}
...
q("yt.logging.errors.log",function(a,b,c,d,e){c={name:c||H("INNERTUBE_CONTEXT_CLIENT_NAME",1),version:d||H("INNERTUBE_CONTEXT_CLIENT_VERSION",void 0)};e=window&&window.yterr||e||!1;if(a&&e&&!(5<=ce)){e=a.stacktrace;d=a.columnNumber;var f=r("window.location.href");if(v(a))a={message:a,name:"Unknown error",lineNumber:"Not available",fileName:f,stack:"Not available"};else{var h,k,l=!1;try{h=a.lineNumber||a.df||"Not available"}catch(Ca){h="Not available",l=!0}try{k=a.fileName||a.filename||a.sourceURL||
